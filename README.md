...
3. 解压路径不要包含中文字符，推荐 `C:\OWTranslatorLite\` 或 `D:\Tools\OWTranslatorLite\`。
...
3. Keep the extract path free of Chinese characters. Recommended examples: `C:\OWTranslatorLite\` or `D:\Tools\OWTranslatorLite\`.
